...
본 프로젝트는 LG유플러스 멤버십 회원의 혜택 이용률과 서비스 만족도를 높이기 위해 **네이버 지도 API를 기반**으로 위치 정보와 관심사 기반 추천 기능을 연계한 **제휴처 안내 서비스**를 제공합니다.

사용자는 자신의 위치 혹은 사용자가 설정한 위치를 중심으로 주변 LGU+ 멤버십 제휴처 매장을 손쉽게 탐색할 수 있으며, 이용 내역이나 나이대, 시간대 데이터를 바탕으로 **제휴처를 추천**받을 수 있습니다.
...
| 기능명                                                     | 설명                                                                                                                                  |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------- |
| **사용자 정보 및 관심사 기반 제휴처 추천**                 | 사용자의 나이, 성별, 관심 카테고리 등 프로필 정보를 분석하여 맞춤형 LGU+ 멤버십 제휴처를 추천합니다.                                  |
| **LGU+ 멤버십 제휴처 혜택 정보**                           | 각 제휴처의 상세한 혜택 정보를 조회하고, 할인 및 이벤트 등의 최신 정보를 제공합니다.                                                  |
| **실시간 인기 멤버십 제휴처 정보**                         | 현재 시간 기준으로 사용자들이 가장 많이 방문한 인기 제휴처 정보를 실시간으로 제공합니다.                                              |
| **자동 완성 기능을 탑재한 검색 기능**                      | 제휴처 및 키워드 검색 시, 사용자 입력에 따라 자동 완성 및 추천 검색어를 실시간으로 제공합니다.                                        |
| **지도 기반 제휴처 탐색**                                  | 사용자의 현재 위치 주변에 존재하는 LGU+ 제휴처를 지도상에서 확인할 수 있으며, 매장 클릭 시 상세 정보가 제공됩니다.                    |
| **사용자 지정 위치 저장**                                  | 사용자가 자주 방문하거나 관심 있는 위치를 지정하여 빠르게 탐색할 수 있도록 저장할 수 있습니다.                                        |
| **자동 완성 기능을 탑재한 제휴처 매장 검색 기능**          | 제휴처 이름이나 키워드를 입력할 때, 관련 매장을 자동 완성 형태로 실시간으로 제안하여 빠르게 탐색할 수 있습니다.                       |
| **제휴처 즐겨찾기**                                        | 관심 있는 제휴처를 즐겨찾기로 저장하여 언제든지 쉽게 다시 확인할 수 있도록 지원합니다.                                                |
| **사용자 정보 및 관심 카테고리 등 설정 지원(마이페이지)**  | 사용자 프로필 정보, 관심 카테고리, 멤버십 등급, 바코드 번호 등 다양한 설정을 마이페이지에서 관리할 수 있도록 지원합니다.              |
| **바코드 기반 멤버십 혜택 사용**                           | 사용자가 등록한 바코드 번호를 기반으로 실제 사용할 수 있는 멤버십 바코드를 자동 생성하여 제휴처에서 혜택을 받을 수 있도록 지원합니다. |
| **유저 개인 및 전체 사용자 평균 기준 혜택 사용 통계 조회** | 개인의 혜택 사용량과 전체 사용자 평균 사용량을 비교하여 시각적으로 제공합니다.                                                        |
| **혜택 사용 내역 조회**                                    | 사용자가 실제 사용한 제휴처 혜택의 사용 내역과 날짜, 사용처, 할인율 등의 상세 정보를 조회할 수 있도록 제공합니다.                     |
